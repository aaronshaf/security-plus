...
- Account policy enforcement ([James Messer](https://www.youtube.com/watch?v=Hasbtq2LS9c&list=PL5ysgoFoCpZEM8cboeHdRDePc2bOU9CN1&index=98))
  - Credential management
    - "Refers to the processes, services, and software used to store, man- age, and log the use of user credentials." (Conklin)
  - Group policy
    - Group Policy objects (GPOs)
    - "GPOs act through a set of registry settings that can be man- aged via the enterprise." (Conklin)
  - Password complexity
  - Expiration
