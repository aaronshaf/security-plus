...
- Hardware/firmware security ([James Messer](https://www.youtube.com/watch?v=MdLKu4t_RwU&list=PL5ysgoFoCpZEM8cboeHdRDePc2bOU9CN1&index=72))
  ...
  - UEFI/BIOS
    - "Unified Extensible Firmware Interface (UEFI) is the current replacement for BIOS. UEFI offers significant modernization over the decades-old BIOS, including the capabil- ity to deal with modern peripherals such as high-capacity storage and high-bandwidth communications." (Conklin)
